<!-- Space: Projects -->
<!-- Parent: Resume -->
<!-- Title: Contributing GithubFlow Resume -->
<!-- Label: Resume -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to resume project on [GitHub](https://github.com/luismayta/resume), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/resume/pulls).
...
To follow the instructions in this guide and start contributing to resume project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/resume.git
```

Now your **upstream** points to **luismayta/resume**.
...
git fetch upstream # assuming upstream is luismayta/resume
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/resume/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
